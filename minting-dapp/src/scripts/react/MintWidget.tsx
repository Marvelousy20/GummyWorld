          ...
          <div className={`mint-widget ${this.props.loading ? 'animate-pulse saturate-0 pointer-events-none' : ''}`}>
            ...
            <div className="price mb-2">
              ...
              <span className='font-bold'>
                {utils.formatEther(this.props.tokenPrice.mul(this.state.mintAmount))} {this.props.networkConfig.symbol}
              </span>
            </div>
            ...
            <div className="controls mb-4 text-center">
              ...
              <button className="primary ml-2" disabled={this.props.loading} onClick={() => this.mint()}>Mint</button>
            </div>
          </div>
          :
          <div className="cannot-mint text-center">
