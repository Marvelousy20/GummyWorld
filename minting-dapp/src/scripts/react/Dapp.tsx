...
export default class Dapp extends React.Component<Props, State> {
  ...
  render() {
    return (
      <>
        {this.isNotMainnet() ?
          <div className="not-mainnet text-center mb-4">
        ...
        {this.isWalletConnected() ?
          <>
            {this.isContractReady() ?
              ...
              :
              <div className="collection-not-ready text-center mt-2">
          ...
          <div className="no-wallet">
            ...
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2 className='text-center font-bold'>Whitelist Proof</h2>
                <p>
                ...
                {this.state.merkleProofManualAddressFeedbackMessage ? <div className="feedback-message my-2">{this.state.merkleProofManualAddressFeedbackMessage}</div> : null}

                <div className='text-center mt-4'>
                  <label htmlFor="merkle-proof-manual-address">Public address:</label> <br />
  ...
  private async initWallet(): Promise<void>
  {
    ...
    console.log("collection config is :",CollectionConfig.testnet)
